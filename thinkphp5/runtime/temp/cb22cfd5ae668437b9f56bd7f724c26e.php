<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\wamp64\www\pro\TP_shop\thinkphp5\public/../application/index\view\goods\goodsinfo.html";i:1500944579;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="w1224">
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="standard p">
                    ...
                    <a class="paybybill" href="javascript:;" onclick="add(<?php echo $goods['goods_id']; ?>,1,1);">立即购买</a>
                    <a class="addcar" href="javascript:;" onclick="add(<?php echo $goods['goods_id']; ?>,1,0);"><i class="sk"></i>加入购物车</a>

                    <script type="text/javascript">
                       function add(goods_id,num,to_catr)
{
     //console.log($("#buy_goods_form"));
        if($("#buy_goods_form").length > 0){
                $.ajax({
                        type : "POST",
                        url:"/Index/Cart/ajaxAddCart",//url:"/Index/Cart/ajaxCartList",
                        ...
                        success: function(data){    
                               ...
                               else
                               {
                                    ...
                                    layer.open({
                                          ...
                                          area: ['490px', '386px'], //宽高
                                          content:["/index.php/Index/Goods/open_add_cart","no"],
                ...
                $.ajax({
                        ...
                        success: function(data){
                               if(data.status == -1)
                               {
                                    location.href = "/index.php/Index/Goods/goodsInfo&id="+goods_id;   
                               }
                               else
                               {
                                    // 加入购物车有误
                                    ...
                                    layer.open({
                                          ...
                                          skin: 'layui-layer-rim', //加上边框
                                          area: ['490px', '386px'], //宽高
                                          content:"/index.php/Index/Goods/open_add_cart"
                                    });                            
                               }                                                           
                        }
                });            
