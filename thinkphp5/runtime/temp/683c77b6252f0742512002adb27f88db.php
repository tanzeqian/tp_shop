<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"C:\wamp\www\shop\TP_shop\thinkphp5\public/../application/admin\view\adminuser\admin_detail.html";i:1501233668;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       ...
       <a href="/admin/adminuser/user_rank" class="fr top_rt_btn money_icon">管理员列表</a>
      </div>
    <form action="admin_tian" method="post">
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">管理员账号：</span>
        <input type="text" class="textbox textbox_225" name="username" value="" placeholder="管理员账号..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">登陆密码：</span>
        <input type="password" class="textbox textbox_225" name="password" value="" placeholder="管理员密码..."/>
       </li>
       <li>
       ...
       <li>
        ...
        <input type="email" class="textbox textbox_225" name="email" value="" placeholder="电子邮件地址..."/>
       </li>   
       <li>
